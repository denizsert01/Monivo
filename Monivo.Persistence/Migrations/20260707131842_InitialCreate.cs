        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeParameterId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Parameters_TypeParameterId",
                        column: x => x.TypeParameterId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrequencyParameterId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecurringTransactions_Parameters_FrequencyParameterId",
                        column: x => x.FrequencyParameterId,
                        principalTable: "Parameters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecurringTransactions_Parameters_TypeParameterId",
                        column: x => x.TypeParameterId,
                        principalTable: "Parameters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_TypeParameterId",
                table: "Categories",
                column: "TypeParameterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringTransactions_FrequencyParameterId",
                table: "RecurringTransactions",
                column: "FrequencyParameterId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringTransactions_TypeParameterId",
                table: "RecurringTransactions",
                column: "TypeParameterId");
